  ...
  nodes:
    leaf1:
      ...
      exec:
        ...
        - bridge vlan add dev vni5000 vid 5
        ...
        - bridge vlan add dev eth2 vid 5 tagged
        - bridge vlan add dev br5 vid 5 self pvid untagged
        - ip link set eth3 master br8
        - bridge vlan add dev eth3 vid 8 tagged 
        - bridge vlan add dev br8 vid 8 self pvid untagged
    ...
    leaf2:
      ...
      exec:
        ...
        - ip link set vni8000 master br8 addrgenmode none
        - bridge vlan add dev vni8000 vid 8
        - ip link set vni8000 type bridge_slave neigh_suppress on learning off
        - ip link set vni8000 up
        - ip link set br8 up
