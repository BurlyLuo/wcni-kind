  ...
  nodes:
    ...
    r1:
      ...
      exec:
        ...
        - sh -c "nohup /tmp/frr_exporter-1.10.0.linux-amd64/frr_exporter --collector.bgp.peer-types --collector.bgp.peer-hostnames --collector.bgp.next-hop-interface --log.level=debug > /tmp/frr_exporter.log 2>&1 &"
