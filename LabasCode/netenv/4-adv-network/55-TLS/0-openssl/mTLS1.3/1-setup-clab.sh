...
topology:
  nodes:
    ...
    openssl_client:
      ...
      # 2. test step:
      # openssl s_client -connect 10.1.8.10:50008 -cert client.crt -key client.key -CAfile CA_Server.crt -tls1_3
...
# 2. test step:
echo "openssl s_client -connect 10.1.8.10:50008 -cert client.crt -key client.key -CAfile CA_Server.crt -tls1_3"
