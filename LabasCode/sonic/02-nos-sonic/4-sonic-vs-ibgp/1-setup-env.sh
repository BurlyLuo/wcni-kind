...
!
ip route 2.2.2.2/32 10.1.12.2 tag 1
ip route 3.3.3.3/32 10.1.13.2 tag 1
...
enable password zebra
!
ip route 1.1.1.1/32 10.1.12.1 tag 1
ip route 3.3.3.3/32 10.1.12.1 tag 1
...
enable password zebra
!
ip route 1.1.1.1/32 10.1.13.1 tag 1
ip route 2.2.2.2/32 10.1.13.1 tag 1
