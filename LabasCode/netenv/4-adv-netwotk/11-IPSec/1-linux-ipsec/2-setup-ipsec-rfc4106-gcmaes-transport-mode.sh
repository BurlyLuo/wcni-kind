...
name: ipsec-tunnel-mode-aes-gmac
topology:
  nodes:
    gwx:
      kind: linux
    ...
    ipsec1:
      ...
      - ip xfrm policy add src 10.1.5.10/24 dst 10.1.8.10/24 proto tcp sport 81 dport 80 dir in  tmpl src 0.0.0.0 dst 0.0.0.0 proto esp reqid 0xfe51d977 mode transport
