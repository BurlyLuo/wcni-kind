...
topology:
  nodes:
    ...
    ipsec1:
      ...
      - ip xfrm state add src 10.1.5.10 dst 10.1.9.10 proto esp spi 0xfe51d978 reqid 0xfe51d978 mode tunnel auth md5 0x00000000000000000000000000000002 enc aes 0x00000000000000000000000000000001
    ...
    ipsec2:
      ...
      - ip xfrm state add src 10.1.8.10 dst 10.1.9.10 proto esp spi 0xfe51d979 reqid 0xfe51d979 mode tunnel auth md5 0x00000000000000000000000000000002 enc aes 0x00000000000000000000000000000001
