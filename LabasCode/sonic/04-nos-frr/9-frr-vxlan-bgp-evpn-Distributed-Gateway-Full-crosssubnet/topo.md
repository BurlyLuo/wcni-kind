# FRR VXLAN BGP EVPN Distributed-Gateway[Full CrossSubnet]
...
graph TB
    ...
    subgraph "<font color='red'>L2/L3 GW Layer</font>"
        subgraph "leaf1-eth1:1.1.1.11/24"
            ...
            subgraph "bridge br20"
                subgraph "interface: eth3 and vxlan20"
                    leaf1-br20["br20<br/>br20:10.1.8.254/24"]
                end
            end
    ...
    vm4["vm4<br/>10.1.8.11/24<br/>GW:10.1.8.254/24"]

    
    %% links
    spine1 --- leaf1_vrf
    leaf1_vrf -.- leaf1-br10
    leaf1_vrf -.- leaf1-br20
