...
topology:
  ...
  links:
    ...
    - endpoints: ["sonic1:eth4", "sonic2:eth4"]
...
# config PortChannel:
sudo config portchannel add PortChannel0012
sudo config portchannel member add PortChannel0012 Ethernet0
sudo config portchannel member add PortChannel0012 Ethernet12

sudo config vlan member add 5 PortChannel0012 
sudo config vlan member add 8 PortChannel0012
sudo config save -y
"
