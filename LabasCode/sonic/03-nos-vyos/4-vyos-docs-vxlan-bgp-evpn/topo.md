...
graph TB
    ...
    RR1 --- |"RR1:eth2:172.29.1.2/31<br/>↔<br/>R2:eth1:172.29.1.3/31"| R2
    RR1 --- |"RR1:eth3:172.29.1.4/31<br/>↔<br/>R3:eth1:172.29.1.5/31"| R3

    RR2 --- |"RR2:eth1:172.29.2.0/31<br/>↔<br/>R1:eth1:172.29.2.1/31"| R1
    RR2 --- |"RR2:eth2:172.29.2.2/31<br/>↔<br/>R2:eth1:172.29.2.3/31"| R2
    RR2 --- |"RR2:eth3:172.29.2.4/31<br/>↔<br/>R3:eth1:172.29.2.5/31"| R3

    R1 --- |"R1:eth1:access vlan10<br/>↔<br/>PC1:eth1:10.1.5.1/24"| PC1
    R2 --- |"R2:eth1:access vlan10<br/>↔<br/>PC1:eth1:10.1.5.2/24"| PC2
    R3 --- |"R3:eth1:access vlan10<br/>↔<br/>PC1:eth1:10.1.5.3/24"| PC3
```
</div>
