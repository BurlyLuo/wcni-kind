...
topology:
  nodes:
    ...
    ipsec1:
      ...
      - ip xfrm state add src 10.1.5.10 dst 10.1.8.10 proto esp spi 0xfe51d977 reqid 0xfe51d977 mode transport auth md5 0x00000000000000000000000000000002 enc null
      - ip xfrm state add src 10.1.8.10 dst 10.1.5.10 proto esp spi 0xfe51d977 reqid 0xfe51d977 mode transport auth md5 0x00000000000000000000000000000002 enc null
