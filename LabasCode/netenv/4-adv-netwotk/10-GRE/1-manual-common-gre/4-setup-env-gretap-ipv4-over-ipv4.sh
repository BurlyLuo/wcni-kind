...
topology:
  nodes:
    ...
    gre1:
      ...
      - ip l a gre00 type gretap local 10.1.5.10 remote 10.1.8.10
      - ip l s gre00 up
    ...
    gre2:
      ...
      - ip l a gre00 type gretap local 10.1.8.10 remote 10.1.5.10
      - ip l s gre00 up
    ...
    server2:
      ...
      image: 192.168.2.100:5000/nettool
      exec:
      - ip addr add 10.244.1.11/24 dev net0
