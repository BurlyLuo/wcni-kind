  ...
  nodes:
    ...
    leaf1:
      ...
      exec:
        ...
        - ip link add vxlan20 type vxlan id 20 local 1.1.1.11 dstport 4789 nolearning
        - ip link set br20 up
        - ip link set eth3 up
        - ip link set vxlan20 up
        - ip link set eth3 master br20
        - ip link set vxlan20 master br20
        - ip a a 10.1.8.254/24 dev br20
        - ip link set dev br20 address 00:00:01:01:08:fe
