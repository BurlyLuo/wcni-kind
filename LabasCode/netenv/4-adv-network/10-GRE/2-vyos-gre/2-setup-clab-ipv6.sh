  ...
  nodes:
    gre1:
      ...
      binds:
        ...
        - ./ipv6-startup-conf/gre1.cfg:/opt/vyatta/etc/config/config.boot
    ...
    gre2:
      ...
      binds:
        - /lib/modules:/lib/modules
        - ./ipv6-startup-conf/gre2.cfg:/opt/vyatta/etc/config/config.boot
    ...
    gre3:
      ...
      binds:
        - /lib/modules:/lib/modules
        - ./ipv6-startup-conf/gre3.cfg:/opt/vyatta/etc/config/config.boot

    server1:
      kind: linux
      image: 192.168.2.100:5000/nettool
      exec:
      - ip addr add 10:1:5::10/64 dev net0
