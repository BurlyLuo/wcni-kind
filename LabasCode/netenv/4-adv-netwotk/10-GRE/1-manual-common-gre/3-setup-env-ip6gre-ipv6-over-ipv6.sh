...
topology:
  nodes:
    ...
    gre1:
      ...
      - ip l a gre00 type ip6gre local 10:1:5::10 remote 10:1:8::10
      - ip a a 10:244:1::0/128 dev gre00
      - ip l s gre00 up

      - ip -6 route replace default via 10:1:5::1 dev eth2 

      - ip -6 r a 10:244:2::/64 via 10:244:2::0 dev gre00 onlink
    ...
    gre2:
      ...
      - ip l a gre00 type ip6gre local 10:1:8::10 remote 10:1:5::10
      - ip a a 10:244:2::0/128 dev gre00
      - ip l s gre00 up

      - ip -6 route replace default via 10:1:8::1 dev eth2

      - ip -6 r a 10:244:1::/64 via 10:244:1::0 dev gre00 onlink
    ...
    server2:
      ...
      - ip -6 route replace default via 10:244:2::1
